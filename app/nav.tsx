    ...
    return (
      <Popover className="relative">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex items-center justify-between py-6 md:justify-start md:space-x-10 border-b border-slate-200 space-x-6 dark:border-slate-200/5">
            ...
            <Popover.Group as="nav" className="hidden space-x-10 md:flex">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        ...
                        'group inline-flex items-center rounded-md text-base font-medium hover:text-white-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
                      )}
                    >
                      <span>Solutions</span>
                      <ChevronDownIcon
              ...
              <a href="#" className="text-base font-medium text-white-500 hover:text-white-900">
                Pricing
              </a>
              <a href="#" className="text-base font-medium text-white-500 hover:text-white-900">
                Docs
